...
FIELD_METADATA: Final[tuple[FieldMetadata, ...]] = (
    ...
    _restart("exchange.passphrase", sensitive=True),
    _restart("exchange.memo", sensitive=True),
    _restart("exchange.operator_id", sensitive=True),
    _restart("exchange.account_address", sensitive=True),
    _restart("exchange.api_wallet_signer", sensitive=True),
